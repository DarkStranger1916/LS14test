...
ent-PosterContrabandMissingGloves = Пропавшие перчатки
    .desc = Этот плакат описывает возмущение, возникшее после того, как NanoTransen сократила финансовые расходы на закупку изолирующих перчаток.
ent-PosterContrabandHackingGuide = Руководство по взлому
    .desc = Этот плакат подробно описывает внутреннюю работу стандартных воздушных шлюзов NanoTransen. К сожалению, он устарел.
ent-PosterContrabandRIPBadger = Спите спокойно, барсуки
    .desc = Этот провокационный плакат рассказывает о геноциде, устроенном NanoTransen на космической станции, полной барсуков.
...
ent-PosterContrabandPower = Сила
    .desc = Плакат, который изображает власть за пределами NanoTransen.
...
ent-PosterContrabandRebelsUnite = Мятежники объединяйтесь
    .desc = Плакат, призывающий читателя восстать против NanoTransen.
...
ent-PosterLegitNanotrasenLogo = Логотип NanoTransen
    .desc = Плакат с изображением логотипа NanoTransen.
...
ent-PosterLegit50thAnniversaryVintageReprint = Винтажная перепечатка к 50-летнему юбилею
    .desc = Перепечатка плаката 2505 года, посвященного 50-летию компании Nanoposters Manufacturing, дочерней компании NanoTransen.
ent-PosterLegitFruitBowl = Миска с фруктами
    .desc = Просто, но впечатляюще.
ent-PosterLegitPDAAd = Реклама КПК
    .desc = Плакат, рекламирующий новейшие КПК от поставщиков NanoTransen.
ent-PosterLegitEnlist = Вступай!
    .desc = Запишитесь в резерв эскадрона смерти NanoTransen сегодня!
...
ent-PosterLegitNoERP = Скажи "да" ERP!
    .desc = Этот плакат напоминает экипажу, что эротика и порнография разрешены на станциях "NanoTransen".
...
ent-PosterLegitThereIsNoGasGiant = Газового гиганта не существует
    .desc = NanoTransen распространила плакаты, подобные этому, по всем станциям, напоминая, что слухи о газовом гиганте недостоверны.
...
ent-PosterLegitVacation = Корпоративные привилегии NanoTransen: Отпуск
