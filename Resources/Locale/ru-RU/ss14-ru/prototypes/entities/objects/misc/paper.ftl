...
ent-PenCentcom = ручка Центком
    .desc = В стремлении не отстать от "мощи" бюрократической машины Cybersun, NanoTransen создала реплику их кибер-ручки в своём корпоративном стиле. Кажется, они забыли, что являются партнёрами.
