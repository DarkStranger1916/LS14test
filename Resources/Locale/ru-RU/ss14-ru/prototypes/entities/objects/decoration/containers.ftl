...
ent-ShippingContainerNanotrasen = грузовой контейнер NanoTransen
    .desc = Контейнер стандартного размера для транспортировки больших объёмов грузов. На этом контейнере изображен логотип компании NanoTransen, и поэтому внутри может быть что угодно.
