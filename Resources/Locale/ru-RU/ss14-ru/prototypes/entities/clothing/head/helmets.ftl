...
ent-ClothingHeadHelmetSwat = шлем спецназа
    .desc = Очень прочный шлем, широко используемый военизированными организациями. На его верхней части выгравирован логотип NanoTransen.
...
ent-ClothingHeadHelmetERTLeader = шлем лидера ОБР
    .desc = Атмосферный шлем, который носят лидеры отрядов быстрого реагирования NanoTransen. Имеет голубой фонарь.
ent-ClothingHeadHelmetERTSecurity = шлем офицера безопасности ОБР
    .desc = Атмосферный шлем, который носят офицеры безопасности отрядов быстрого реагирования NanoTransen. Имеет красный фонарь.
ent-ClothingHeadHelmetERTMedic = шлем медика ОБР
    .desc = Атмосферный шлем, который носят медики отрядов быстрого реагирования NanoTransen. Имеет белый фонарь.
ent-ClothingHeadHelmetERTEngineer = шлем инженера ОБР
    .desc = Атмосферный шлем, который носят инженеры отрядов быстрого реагирования NanoTransen. Имеет оранжевый фонарь.
ent-ClothingHeadHelmetERTJanitor = шлем уборщика ОБР
    .desc = Атмосферный шлем, который носят уборщики отрядов быстрого реагирования NanoTransen. Имеет тёмно-фиолетовый фонарь.
