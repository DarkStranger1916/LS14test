...
ent-ClothingUniformJumpsuitSecGrey = серый комбинезон службы безопасности
    .desc = Пережиток прошлых лет, они использовались до того, как в NanoTransen решили, что дешевле красить костюмы в красный цвет вместо того, чтобы смывать кровь.
ent-ClothingUniformJumpsuitWarden = униформа смотрителя
    .desc = Формальный костюм службы безопасности для офицеров в комплекте с пряжкой для ремня NanoTransen.
...
ent-ClothingUniformJumpsuitBlueShieldOfficer = комбинезон офицера "Синий Щит"
    .desc = Синий комбинезон с бирюзовыми погонами и символом Щита на спине. Эту форму используют Офицеры подразделения "Синий Щит" NanoTransen. Выглядит стильно.
