...
ent-ClothingUniformJumpsuitRepairmanSyndie = комбинезон ремонтника Синдиката
    .desc = Функциональный, модный, крутой. Инженеры NanoTransen мечтают выглядеть так же хорошо, как и вы.
ent-ClothingUniformJumpsuitParamedicNT = комбинезон парамедика
    .desc = Простой бело-голубой комбинезон, предназначенный для парамедиков NanoTransen, работающих в боевых секторах.
