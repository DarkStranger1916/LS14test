ent-CrateServiceJanitorialSupplies = ящик с уборочным инвентарем
    .desc = Победите копоть и грязь с Незаменимыми Припасами для Уборки от NanoTransen! Содержит три ведра, таблички мокрого пола, и очищающие гранаты. Также содержит одну швабру, тряпку, щётку, чистящий спрей, и мусорный пакет.
